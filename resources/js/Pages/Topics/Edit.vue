...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6 p-3">
    <div class="md:col-span-3">
      <div class="px-4 sm:px-0">
        <h3 class="text-lg font-medium leading-6 text-gray-900">Create Topic</h3>
        <p class="mt-1 text-sm text-gray-600">Fill in the information below to create a topic.</p>
      </div>
    </div>
    <div class="mt-5 md:mt-0 md:col-span-3">
      <form action="#" method="POST" @submit.prevent="updateTopic">
            ...
            <div>
              ...
              <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">
                  ...
                  <div class="m-2 p-2">
                      <img :src="image" class="w-12 h-12 mx-auto rounded">
                  </div>
                  <div class="flex text-sm text-gray-600">
                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      <span>Upload a file</span>
                      <input id="file-upload" name="file-upload"  @input="form.image = $event.target.files[0]" type="file" class="sr-only">
                    </label>
...
import { Inertia } from '@inertiajs/inertia'
    ...
    function updateTopic() {
      Inertia.put(`/topics/${props.topic.id}`, {
            _method: 'put',
            name: form.name,
            image: form.image,
      })
